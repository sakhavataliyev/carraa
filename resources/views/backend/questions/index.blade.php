          ...
          <div class="card border shadow-xs mb-4">
            <div class="card-header border-bottom pb-0">
              <div class="d-sm-flex align-items-center">
                <div>
                  <h6 class="font-weight-semibold text-lg mb-0">Question</h6>
                ...
                <div class="ms-auto d-flex">
                  ...
                  <a class="btn-inner--text text-white" href="{{ route('questions.create') }}">
                  ...
                  <tr>
                    <td>
                      <div class="d-flex px-2 py-1">
                          <h6 class="text-md text-dark font-weight-semibold mt-2 me-2">{{ $question->firstItem() + $key }}</h6>
                    ...
                    {{-- <td>
                      <p class="text-sm text-dark font-weight-semibold mb-0">{{ $row->description }}</p>
                    ...
                    <td class="align-middle">
                      <a href="{{ route('questions.show', $row->id) }}" class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip" data-bs-title="Show page">
                        <i class="fa-regular fa-eye  text-primary" style="font-size: 0.9rem !important;" ></i>
                      </a>
                      <a href="{{ route('questions.edit', $row->id) }}" class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip" data-bs-title="Edit page">
                        <i class="fa-regular fa-pen-to-square text-primary mx-4" style="font-size: 0.9rem !important;"></i>
                      </a>

                      <form method="POST" action="{{ route('questions.destroy', $row->id) }}" style="display: inline-block;">
                        @csrf
                        @method('DELETE')
