...
<div class="container my-3 py-3">
    <div class="row">
        <div class="col-12 col-xl-12 mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('staticpages.update', $staticpage) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              value="{{ old('title', $staticpage->title) }}" placeholder="Title" onfocus="focused(this)" onfocusout="defocused(this)" required>
                            </div>
                          </div>                          
                     </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control{{($errors->first('body') ? " is-invalid" : "")}}" name="body"  id="exampleFormControlTextarea1" rows="3">{{ old('body', $staticpage->body) }}</textarea>
                          {{-- <textarea id="editor" class="form-control{{($errors->first('body') ? " is-invalid" : "")}}" name="body" rows="6">{!! old('body', $staticpage->body) !!}</textarea> --}}
                        </div>
                      </div>
                </div>
                    ...
                    <div class="form-check form-switch">
                      ...
                      {{-- <div class="form-group">
                        ...
                        <div class="form-check mb-0">
                          <input class="form-check-input" type="checkbox" name="status" id="flexCheckDefault" {{ $staticpage->status==1?'checked':'' }} >
                        </div> 
                      </div> --}}
                    </div>
