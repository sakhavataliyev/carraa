...
<div class="container my-3 py-3">
    <div class="row">
            ...
            <div class="card-header border-bottom pb-0">
              <div class="d-sm-flex align-items-center">
                ...
                <div class="ms-auto d-flex">
                  ...
                  <a class="btn-inner--text text-white" href="{{ route('process.create') }}">
                  ...
                  <tr>
                    <td>
                      <div class="d-flex px-2 py-1">
                          <h6 class="text-md text-dark font-weight-semibold mt-2 me-2">{{ $process->firstItem() + $key }}</h6>
                    ...
                    <td class="align-middle">
                      <a href="{{ route('process.show', $row->id) }}" class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip" data-bs-title="Show page">
                        <i class="fa-regular fa-eye  text-primary" style="font-size: 0.9rem !important;" ></i>
                      </a>
                      <a href="{{ route('process.edit', $row->id) }}" class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip" data-bs-title="Edit page">
                        <i class="fa-regular fa-pen-to-square text-primary mx-4" style="font-size: 0.9rem !important;"></i>
                      </a>

                      <form method="POST" action="{{ route('process.destroy', $row->id) }}" style="display: inline-block;">
                        @csrf
                        @method('DELETE')
      ...
      {{-- <div class="card-footer py-4"> --}}
        {{ $process->links("pagination::bootstrap-4") }}
      {{-- </div> --}}
