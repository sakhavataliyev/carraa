    ...
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
       ...
       <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link {{ Request::is('solutions*') ? 'active' : '' }}" href="{{ route('solutions.index') }}">
            <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-sliders"></i>
              {{-- <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" class="ms-2" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                <title>sliders</title>
        ...
        <li class="nav-item">
          <a class="nav-link {{ Request::is('process*') ? 'active' : '' }}" href="{{ route('process.index') }}">
            <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-sliders"></i>
            </div>
            <span class="nav-link-text ms-1">Processes</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link {{ Request::is('priceplans*') ? 'active' : '' }}" href="{{ route('priceplans.index') }}">
            <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-sliders"></i>
            </div>
